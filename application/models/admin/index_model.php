...
class index_model extends CI_Model {
	...
	function getRole($roleId){
		$query=$this->db->select('prive')->get_where('role',array('id'=>$roleId));
	...
	*/
	...
	function  getMaxLevel(){
		$query=$this->db->select ('id,name,pid,t,url,listorder')->order_by("listorder", "asc")->get_where('menu',array('t'=>1));
		$data =$query->result_array();				
		return $data;
	...
	function getMenu($roleArray){			
		$this->db->select('id,name,pid,t,url,listorder');
		$this->db->where_in('id', $roleArray);
	...
	function leftMenu($id){
		$query=$this->db->select ('id,name,pid,t,url,listorder')->order_by("listorder", "asc")->get_where('menu',array('pid'=>$id,'t'=>2));
		$data =$query->result_array();				
		return $data;
	}	
