...
<div class="pd-20">
  <div class="Huiform">
    <form action="<?php echo site_url("admin/vide/add")?>" method="post"  id="videform"  enctype="multipart/form-data"/>
      <table class="table table-bg">
        <tbody>
          <tr>         
            <th width="100" class="text-r"><span class="c-red">*</span> 视频标题：</th>
            <td><input type="text" style="width:500px" class="input-text" id="title" name="title"  value="<?php echo $this->session->flashdata('title');?>" onFocus="if(this.value==''){$(this).next().hide();return}"></td>
          </tr>
         
         <tr>
            <th width="100" class="text-r"><span class="c-red">*</span>缩略图：</th>
            <td><input type="file" style="width:500px" class="input-text" id="coverUrl" name="coverUrl">           
            <span style="padding-left:5px;color:red"><?php echo $this->session->flashdata('coverUrlError');?></span>
            </td>
             
         </tr>        
         <tr>
            <!--<th width="100" class="text-r"><span class="c-red">*</span>视频：</br>
             <span style="padding-left:5px;color:red">(仅限mp4格式)</span></th>
            <td><input type="file" style="width:500px" class="input-text" id="videoUrl" name="videoUrl">
            <span style="padding-left:5px;color:red"><?php echo $this->session->flashdata('videoUrlError');?></span>
         ...
         <tr>
          ...
          <td><script id="editor" name="abstract" type="text/plain" style="width:100%; height:200px;">
          		<?php echo $this->session->flashdata('abstract');?>
          </script>         	
         <span style="padding-left:5px;color:red" id="content2"><?php echo $this->session->flashdata('content2');?></span>       
          	...
          	<th>
          		...
          		<option value="">请选择视频行业</option>	
        			<?php foreach ($industry as $k=>$v):?>
						<option class="clssId" value="<?php echo $v['id']?>"><?php echo $v['industryName']?></option>					
        			<?php endforeach;?>      		 		       		
     			</select>
          	</th>                   	
         </tr>                
          ...
          <th class="text-r"><span class="c-red">*</span>资源分类：</th>
          	<th>
          		<select class="select" name="resourceClass" id="classId"  onFocus="if(this.value==''){$(this).next().hide();return}" >	
