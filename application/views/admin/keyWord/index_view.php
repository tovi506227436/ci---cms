...
<div class="pd-20">
  <div class="cl pd-5 bg-1 bk-gray mt-20"> 
     <a class="btn btn-primary radius" href="javascript:;" onClick="layer_show('500','600','网站关键词','<?php echo site_url('admin/admin/addAdmin');?>')"><i class="icon-plus"></i>添加管理员</a></span>
