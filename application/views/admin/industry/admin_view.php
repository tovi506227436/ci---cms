...
<div class="pd-20">
  <div class="Huiform">
    <form action="<?php echo site_url("admin/industry/add")?>" method="post">
      <table class="table table-bg">
        <tbody>
          <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 行业分类：</th>
            <td><input type="text" style="width:200px" class="input-text" id="industryName" name="industryName" datatype="*" nullmsg="行业分类不能为空"></td>
          </tr>
          <tr>
            <th class="text-r">排序：</th>
            <td><input type="text" style="width:300px" class="input-text" id="orderlist" name="orderlist"></td>
          </tr>        
           <tr>
